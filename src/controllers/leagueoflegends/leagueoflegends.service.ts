...
export class LeagueoflegendsService {
  ...
  public async createChampion(value: Champion): Promise<Champion> {
    const result = await this.championModel.findOne({
      where: { key: value.key },
    });
    if (!result) {
  ...
  public async createChampionDescription(
    value: ChampionDescription,
  ): Promise<ChampionDescription> {
  ...
  public async createPassive(value: Passive): Promise<Passive> {
    const result = await this.passiveModel.findOne({
      where: { key: value.key },
    });
    if (!result) {
  ...
  public async createPassiveDescription(
    value: PassiveDescription,
  ): Promise<PassiveDescription> {
  ...
  public async createSkinsDescription(
    value: SkinsDescription,
  ): Promise<SkinsDescription> {
  ...
  public async createSpells(value: Spells): Promise<Spells> {
    const result = await this.spellsModel.findOne({
      where: { key: value.key },
    });
    if (!result) {
  ...
  public async createSpellsDescription(
    value: SpellsDescription,
  ): Promise<SpellsDescription> {
